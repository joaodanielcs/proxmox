...
HOSTNAME=$(hostname)
case "$HOSTNAME" in
      pve01) SRV_IP="192.168.0.31"; SRV_NET="192.168.0.31/21"; BOND2_CIDR="172.31.163.1/28"; STATE="MASTER"; PRIORITY="100"; UNICAST_PEER1="192.168.0.32"; UNICAST_PEER2="192.168.0.33"; UNICAST_PEER3="192.168.0.34"; UNICAST_PEER4="192.168.0.35"; UNICAST_PEER5="192.168.0.36"; UNICAST_PEER6="192.168.0.37"; BOND_SLAVE="enp68s0f1"; BOND_PRIMARY="enp68s0f0" ;;
      pve02) SRV_IP="192.168.0.32"; SRV_NET="192.168.0.32/21"; BOND2_CIDR="172.31.163.2/28"; STATE="BACKUP"; PRIORITY="99"; UNICAST_PEER1="192.168.0.31"; UNICAST_PEER2="192.168.0.33"; UNICAST_PEER3="192.168.0.34"; UNICAST_PEER4="192.168.0.35"; UNICAST_PEER5="192.168.0.36"; UNICAST_PEER6="192.168.0.37"; BOND_SLAVE="enp68s0f1"; BOND_PRIMARY="enp68s0f0" ;;
      pve03) SRV_IP="192.168.0.33"; SRV_NET="192.168.0.33/21"; BOND2_CIDR="172.31.163.3/28"; STATE="BACKUP"; PRIORITY="98"; UNICAST_PEER1="192.168.0.31"; UNICAST_PEER2="192.168.0.32"; UNICAST_PEER3="192.168.0.34"; UNICAST_PEER4="192.168.0.35"; UNICAST_PEER5="192.168.0.36"; UNICAST_PEER6="192.168.0.37"; BOND_SLAVE="enp68s0f1"; BOND_PRIMARY="enp68s0f0" ;;
      pve04) SRV_IP="192.168.0.34"; SRV_NET="192.168.0.34/21"; BOND2_CIDR="172.31.163.4/28"; STATE="BACKUP"; PRIORITY="97"; UNICAST_PEER1="192.168.0.31"; UNICAST_PEER2="192.168.0.32"; UNICAST_PEER3="192.168.0.33"; UNICAST_PEER4="192.168.0.35"; UNICAST_PEER5="192.168.0.36"; UNICAST_PEER6="192.168.0.37"; BOND_SLAVE="enp5s0f1"; BOND_PRIMARY="enp5s0f0" ;;
      pve05) SRV_IP="192.168.0.35"; SRV_NET="192.168.0.35/21"; BOND2_CIDR="172.31.163.5/28"; STATE="BACKUP"; PRIORITY="96"; UNICAST_PEER1="192.168.0.31"; UNICAST_PEER2="192.168.0.32"; UNICAST_PEER3="192.168.0.33"; UNICAST_PEER4="192.168.0.34"; UNICAST_PEER5="192.168.0.36"; UNICAST_PEER6="192.168.0.37"; BOND_SLAVE="enp5s0f1"; BOND_PRIMARY="enp5s0f0" ;;
      pve06) SRV_IP="192.168.0.36"; SRV_NET="192.168.0.36/21"; BOND2_CIDR="172.31.163.6/28"; STATE="BACKUP"; PRIORITY="95"; UNICAST_PEER1="192.168.0.31"; UNICAST_PEER2="192.168.0.32"; UNICAST_PEER3="192.168.0.33"; UNICAST_PEER4="192.168.0.34"; UNICAST_PEER5="192.168.0.35"; UNICAST_PEER6="192.168.0.37"; BOND_SLAVE="enp5s0f1"; BOND_PRIMARY="enp5s0f0" ;;
      pve07) SRV_IP="192.168.0.37"; SRV_NET="192.168.0.37/21"; BOND2_CIDR="172.31.163.7/28"; STATE="BACKUP"; PRIORITY="94"; UNICAST_PEER1="192.168.0.31"; UNICAST_PEER2="192.168.0.32"; UNICAST_PEER3="192.168.0.33"; UNICAST_PEER4="192.168.0.34"; UNICAST_PEER5="192.168.0.35"; UNICAST_PEER6="192.168.0.36"; BOND_SLAVE="enp5s0f1"; BOND_PRIMARY="enp5s0f0" ;;
esac
...
auto $BOND_PRIMARY
iface $BOND_PRIMARY inet manual

auto $BOND_SLAVE
iface $BOND_SLAVE inet manual
...
iface bond2 inet static
        address $BOND2_CIDR
        bond-slaves $BOND_PRIMARY $BOND_SLAVE
        bond-miimon 100
